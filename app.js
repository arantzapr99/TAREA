...
const listado = ["-Solo se aceptan minusculas" , "-No se aceptan mayusculas" , "-No se aceptan acentos" , "-No se aceptan simbologia" , "-No se acepta letra Ñ"];
...
function borrarTexto() {
    let borrar = document.getElementById("campoTexto", "campoMensaje").value = "";
    borrar = document.getElementById("campoMensaje").value = "";
    borrar = document.getElementById("mensajes").value = "";
